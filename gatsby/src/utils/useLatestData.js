...
// create a variable for our query since otherwise we would be writing the same thing twice
...
export default function useLatestData() {
  ...
  useEffect(function () {
    // when the component loads, run this code and here we fetch the data
    fetch(process.env.GATSBY_GRAPHQL_ENDPOINT, {
      // you might think this is a GET but it is a POST
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
      // gql : see note above
      // NOTE! This is a query we are writing for the sanity graphql side so the naming will look different than gatsby
